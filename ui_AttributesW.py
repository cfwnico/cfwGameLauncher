...
################################################################################
## Form generated from reading UI file 'AttributesWmOnEbn.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_8 = QLabel(self.normal_tab)
        self.label_8.setObjectName(u"label_8")

        self.gridLayout_2.addWidget(self.label_8, 14, 0, 1, 1)

        self.last_run_label = QLabel(self.normal_tab)
        ...
        self.total_time_label = QLabel(self.normal_tab)
        ...
        self.label = QLabel(self.normal_tab)
        ...
        self.use_ncd_checkbox = QCheckBox(self.tab_2)
        ...
        self.savedata_edit = QLineEdit(self.tab_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("Dialog", u"\u5b58\u6863\u4e91\u540c\u6b65", None))
